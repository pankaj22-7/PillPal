...
/**
 * Global colour & typography palette
 * ------------------------------------------------
 * Extend React-Native-Paper’s MD3 base theme.
 */
const theme = {
  ...PaperTheme,
  colors: {
...
/**
 * Elderly-friendly sizing helpers
 * ------------------------------------------------
 * Re-use these in TextInput, Button, etc.
 */
...
// Named + default exports so you can import either way
export { theme };
